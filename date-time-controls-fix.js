(() => {
  ...
  const CONFIG = {
    birthDate: {
      ...
      help: 'Digite a data ou selecione no calendário',
    ...
    transportTime: {
      type: 'time',
      placeholder: 'HH:MM',
      help: 'Digite o horário ou selecione no relógio',
  ...
  function iconSvg(type) {
    if (type === 'time') {
      return '<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8.5"></circle><path d="M12 7.5v5l3.5 2"></path></svg>';
    }
    return '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="4" y="5.5" width="16" height="14" rx="2"></rect><path d="M8 3.5v4M16 3.5v4M4 9.5h16"></path><rect x="8" y="12" width="3" height="3" rx=".5"></rect></svg>';
  }
  ...
  function addStyles() {
    ...
    style.textContent = `
      .heuro-date-field{display:block;width:100%;min-width:0}
      .heuro-date-field>.heuro-date-label{display:block;margin:0 0 8px;font:inherit;font-weight:700;color:#14233f}
